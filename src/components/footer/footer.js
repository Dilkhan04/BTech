                    ...
                    <div className={classes.linksLeft}>
                        ...
                        <span>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link to='/'>Техника для бизнеса</Link>
                                </li>
                                <li>
                        ...
                        <span>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link to='/'>Политика магазина</Link>
                                </li>
                            </ul>
                        </span>
                        <span>
                            ...
                            <ul>
                                ...
                                <li>
                                    <Link to='/'>
                                        Оставить отзыв
                                        <br /> о качестве товара
                                    </Link>
                                </li>
                                <li>
                                    <Link to='/'>Канал в Telegram</Link>
                                </li>
                            </ul>
                        </span>
                    </div>
                ...
                <div className={classes.socLinks}>
                    <span>
                        ...
                        <div className={classes.socs}>
                            <span>
                                <a href='https://www.instagram.com/nalmatov6/'>
                                    <Instagram />
                                </a>
                            </span>
                            <span>
